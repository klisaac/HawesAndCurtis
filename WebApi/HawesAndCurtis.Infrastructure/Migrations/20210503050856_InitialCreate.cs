        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(16,3)", nullable: true),
                    ProductTypeId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRecommendation", x => x.ProductRecommendationId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ProductRecommendation_Product_RecommendedProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRecommendation_RecommendedProductId",
                table: "ProductRecommendation",
